...
# ------------------------训练------------------------------
    ...
    for e in range(num_epoch):
        ...
        for step, batch in enumerate(training_iter):
            ...
            input_ids,all_adj, input_mask, segment_ids, start_positions, end_positions, answer_types = batch
            
            start_logits, end_logits, answer_type_logits = model(input_ids, all_adj,segment_ids, input_mask)
            # print('############################ 训练参数 ###########################')
            # print(all_adj)
            # print(start_logits)
            # print(end_logits)
