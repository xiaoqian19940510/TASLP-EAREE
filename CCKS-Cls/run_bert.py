...
def run_train(args):
    ...
    if args.resume_path:
        ...
        BertForMultiLable.unfreeze(model,10,11)
...
def run_test(args):
    ...
    all_df.columns = ['id','zy','gfgqzr','qs','tz','ggjc','TypeNumber0','TypeNumber1']
    ...
    all_df.to_csv("/home/LAB/liqian/test/game/Ori_graph/CCKS-Cls/test_output/cls_out.csv",index=False)
